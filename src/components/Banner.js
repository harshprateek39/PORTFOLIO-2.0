...
import image from "../assets/figma2.png";
...
const Banner = () => {
  ...
  return<AnimatePresence> <motion.section initial={{ x:-100 ,opacity:0}} whileInView={{ x:0, opacity:1}}  transition={{  duration: 1, staggerChildren:0.5 ,delayChildren:1 }}   className='   min-h-screen md:pl-14 md:grid flex flex-col   grid-flow-row md:grid-cols-2 gap-1 grid-cols-1 md:pr-14  ' id='home' >
